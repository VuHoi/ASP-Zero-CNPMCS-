...
export class BudgetComponent extends AppComponentBase implements AfterViewInit, OnInit {
    ...
    applyFilters(): void {
        ...
        this._router.navigate(['app/gwebsite/budget', {
