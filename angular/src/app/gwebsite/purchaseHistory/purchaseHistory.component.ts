...
export class PurchaseHistoryComponent extends AppComponentBase implements AfterViewInit, OnInit {
    ...
    /**
     * Hàm get danh sách PurchaseHistory
     * @param event
     */
    getPurchaseHistorys(event?: LazyLoadEvent) {
